PS_OUTPUT PerPixelNormalParallaxPS(VS_OUTPUT_PERPIXELNORMALSPECULAR In) { // toeye nodig, maar specular term gaan we niet berekenen
	PS_OUTPUT outPS;
...
technique PerPixelNormalParallax {
	pass P0 {
		VertexShader = compile vs_3_0 PerPixelNormalSpecularVS();
		PixelShader  = compile ps_3_0 PerPixelNormalParallaxPS();
	}
}
